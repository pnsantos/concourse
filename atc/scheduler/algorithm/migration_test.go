...
var _ = FDescribeTable("Migrating build inputs and outputs into successful build outputs",
	(Example).Run,
	...
	Entry("migrates part of the build inputs/outputs and finds a candidate with version every", Example{
		...
		Result: Result{
			...
			ExpectedMigrated: map[int]map[int][]string{
				...
				1: map[int][]string{
					1: []string{migratorConvertToMD5("ryv1")},
				},
				2: map[int][]string{
					1: []string{migratorConvertToMD5("ryv2")},
				},
				3: map[int][]string{
					1: []string{migratorConvertToMD5("ryv3")},
				},
				6: map[int][]string{
					1: []string{migratorConvertToMD5("ryv3")},
				},
	...
	FEntry("migrates part of the build inputs/outputs and finds a candidate with version latest", Example{
		DB: DB{
			NeedsV6Migration: true,
	...
	Entry("migrates build inputs/outputs with rerun builds in the right order", Example{
		...
		Result: Result{
			...
			ExpectedMigrated: map[int]map[int][]string{
				...
				2: map[int][]string{
					1: []string{migratorConvertToMD5("rxv5")},
				},
				5: map[int][]string{
					1: []string{migratorConvertToMD5("rxv5")},
				},
